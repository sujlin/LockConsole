...
```text
~/MALightingTechnology/gma3_library/datapools/plugins/jl_lock_console/LockConsole.xml
~/MALightingTechnology/gma3_library/datapools/plugins/jl_lock_console/LockConsole.lua
```

同时会生成本地备份：

```text
dist/LockConsole.xml
dist/LockConsole.lua
```
...
```text
Import "jl_lock_console/LockConsole.xml" At Plugin 1 /NoConfirmation
Call Plugin 1
```
